...
STATIC_METADATA2_BEGIN(DEVICE, SCALER, SENSOR_DRVNAME_OV5695_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.scaler
//------------------------------------------------------------------------------
//==========================================================================
...
// support if enable yuv reprocessing
/*
CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32) //ADD full input
CONFIG_ENTRY_VALUE(2592, MINT32)
CONFIG_ENTRY_VALUE(1944, MINT32)
CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_INPUT, MINT32)
*/
...
CONFIG_METADATA_END()
//==========================================================================
// support if reprocessing enable
/*
