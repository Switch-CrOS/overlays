...
CROS_WORKON_COMMIT="3dad4297731618829754076de1c4a645ca8c21cb"
CROS_WORKON_TREE=("518b50f8b6d01e95cbd933487ed7c6452ac4acb3" "dd2fad2176ff8c02ae553e5a695b908e2ca4fe71" "c1d5aacf30286814ebb57a48a3fbd7d4afefb285" "55903d6d672e8bdad40486765d522b08aa485668" "563a31cc4efc68801a445225fd7c6c110280d904" "6ecdd7d2d693af516eebbc297e65dbd440964da2" "f91b6afd5f2ae04ee9a2c19109a3a4a36f7659e6" "43eb4f30218ee6fc055f185786d914bccd668086")
...
# switch-t210 patches:
#  * relax DeviceInfo::DelayedDeviceCreationTask DCHECK that only holds on
#    Linux >= 4.14 (ARPHRD_RAWIP); without it shill aborts every ~5s.
#  * ignore the kernel-auto-created dummy0/bond0 interfaces so shill stops
#    trying to DHCP a bogus Ethernet device forever.
PATCHES=(
	"${FILESDIR}/shill-allow-missing-mac-on-linux-4.9.patch"
	"${FILESDIR}/shill-ignore-dummy-bond-interfaces.patch"
)
